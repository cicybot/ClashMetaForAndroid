...
class PermissionRequestTransparentActivity : Activity() {
    private val logTag = "MediaProjectionActivity"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        // Transparent theme should be set in your manifest
        Log.d(
            logTag,
            "onCreate PermissionRequestTransparentActivity: intent.action: ${intent.action}"
        )
